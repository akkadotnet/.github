# Contributing to Akka.NET Member Projects
...
We have a [very detailed guide on how to contribute to the Akka.NET documentation here](https://getakka.net/community/contributing/documentation-guidelines.html).
